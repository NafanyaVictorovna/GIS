...
public class MethodWU implements Method {
	
	public MethodWU(Segment segm, Graphics g){
		segment = segm;
		graph = g;
	...
	public void init() {
		...
		//�������� ������ ������
		if((delX == delY) || (delX == 0) || (delY == 0)){		
			plot(segment.getPoint1(), segment.getPoint2());
			var = true; 
		}	
	...
	if(!var){
		...
		lists.add(new Point((int)X1, (int)Y1));	
